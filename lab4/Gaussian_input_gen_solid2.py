                                    ...
                                    if atoms[atom4] == 'C' and atom4 in cycle2:
                                        ...
                                        if all(atoms[neighbor] != 'H' for neighbor in neighbors_c4):
                                            ...
                                            if (bond_matrix[atom1, atom2] and
                                                ...
                                                print(
                                                    f"Знайдений глікозидний зв'язок O-C-N-C: {atoms[atom1]}-{atoms[atom2]}-{atoms[atom3]}-{atoms[atom4]}")
                                                print(
...
def generate_gaussian_files(atoms, coordinates, torsion_atoms, atoms_to_rotate):
    ...
    for angle in range(0, 360):
        ...
        file_name = os.path.join(output_dir, f"gl_angle_{angle}.gjf")
...
if glycosidic_bond:
    ...
    generate_gaussian_files(atoms, coordinates, glycosidic_bond, atoms_to_rotate)
